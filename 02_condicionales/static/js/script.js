...
Si el producto no está en la lista (usa .includes()), agrégalo al final
...
Si el tamaño de la bodega (.length) es mayor a 5, elimina la última caja con .pop()
 y muestra: "Bodega llena, eliminando último ingreso".
